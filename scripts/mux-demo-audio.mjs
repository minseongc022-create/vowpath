...
const DEMOS = {
  ...
  voice: {
    ...
    files: ["voice-ai-0.mp3", "voice-ai-1.mp3", "voice-ai-2.mp3", "voice-ai-3.mp3", "voice-ai-4.mp3"],
    startOffsetMs: 2200,
    gapsAfterClipMs: [3200, 2400, 3200, 6200],
    volume: 1.1,
  },
  "voice-hvac": {
  ...
  "risk-hold-hvac": {
    ...
    files: ["voice-hvac-gas-0.mp3", "voice-hvac-gas-1.mp3", "voice-hvac-gas-2.mp3", "voice-hvac-gas-3.mp3"],
    startOffsetMs: 2200,
    gapsAfterClipMs: [3200, 2400, 3200],
    volume: 1.1,
  },
  "link-intake": {
