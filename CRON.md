...
Syncs merchant catalog, price/rank snapshots (1-minute buckets, 24h retention), keyword metrics, and competitor alerts when API keys are configured. Demo merchants still get simulated minute-level updates.
