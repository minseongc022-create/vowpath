 ...
 * Retell booking agent uses voice_speed 1.1, deep US male (Marcus/Clyde/Steve).
 */

/** Matches Retell `voice_speed` — ~150 WPM US conversational pace on phone. */
export const DEMO_VOICE_SPEED = 1.1;
...
export const DEMO_EDGE_RATE = "+10%";
