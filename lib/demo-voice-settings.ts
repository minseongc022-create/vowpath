 ...
 * Retell booking agent uses voice_speed 0.88, deep US male (Marcus/Clyde/Steve).
 */

/** Matches Retell `voice_speed` — deliberate, clear American pacing on phone. */
export const DEMO_VOICE_SPEED = 0.88;
...
/** Edge fallback — Guy Neural at slower rate for phone-like clarity. */
export const DEMO_EDGE_VOICE = "en-US-GuyNeural";
export const DEMO_EDGE_RATE = "-8%";
