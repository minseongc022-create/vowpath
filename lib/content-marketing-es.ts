...
export const pricingEs = {
  ...
  subtitle:
    "IA Economy en Lite y Flex. IA Premium en Pro y Scale cuando sube el volumen — elige por despachos, no a ciegas.",
  compare: [
    { label: "Teléfono con IA + enlace SMS", amount: "Incluido" },
    { label: "SMS al dueño (1/2 hold)", amount: "Incluido" },
    { label: "Calidad de IA", amount: "Economy → Premium por plan", highlight: true },
    { label: "CRM / Jobber", amount: "Opcional" },
  ],
  plans: [
    {
      id: "lite" as const,
      ...
      description: "Base más baja. IA Economy. Pagas más solo cuando despachas.",
      price: SITE.liteBasePrice,
      period: "/mes",
      usageLine: `+ ${SITE.litePerBooking} por despacho aprobado`,
      volumeGuide: planVolumeGuideEs("lite"),
      features: [
        "Intake con IA Economy",
        "SMS al equipo con hold 1/2 del dueño",
    ...
    },
    {
      ...
      name: "Flex",
      badge: "Más popular",
      description: "Mejor costo por despacho. Misma IA Economy que Lite.",
      ...
      features: [
        ...
        "Menor costo por despacho que Lite",
        "Rutas por técnico + ventanas de agenda",
        "CRM opcional",
      ],
      recommended: true,
    ...
    },
    {
      ...
      description: "IA Premium a alto volumen. Recargo más bajo en picos.",
      ...
      features: [
        ...
        "Para tormentas / picos · CRM opcional",
      ],
      recommended: false,
