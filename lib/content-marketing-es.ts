...
export const howItWorksEs = {
  ...
  steps: [
    ...
    },
    {
      ...
      description:
        "Opción 1 = emergencia; opción 2 = presupuesto gratis ($0). Agua estándar se despacha sola; fuego o duda espera tu 1 / 2. Solo despachos aprobados cuentan.",
    },
  ],
};
...
export const pricingEs = {
  ...
  plans: [
    ...
    },
    {
      ...
      name: "Flex",
      badge: "Más popular",
      description: "Mejor $/despacho. Estimaciones gratis; pagas cuando apruebas el trabajo.",
      price: SITE.flexBasePrice,
      period: "/mes",
      usageLine: `+ ${SITE.flexPerBooking} por despacho aprobado (estimaciones $0)`,
    ...
    },
    {
      ...
      description: "Tarifa fija + IA Premium. Estimaciones gratis. Solo cuentan despachos de emergencia.",
      price: SITE.proPrice,
      period: "/mes",
      ...
      features: [
        ...
        `${SITE.proIncludedDispatches} despachos de emergencia/mes incluidos`,
        "Recargo predecible — alertas antes · CRM opcional",
      ],
      recommended: false,
    ...
    },
    {
      ...
      description: "IA Premium a alto volumen. Estimaciones gratis. Recargo más bajo en picos.",
