...
export const linkIntakePageCopy = {
  ...
  hvacSystemSectionTitle: "About your equipment (optional)",
  hvacSystemTypeLabel: "What stopped working?",
  hvacSystemTypePlaceholder: "e.g. furnace, AC, heat pump, boiler",
  hvacSystemTypeHint: "Just the machine that's broken or not working right — skip if you're not sure.",
  hvacActiveIssueLabel: "No heat / no cool right now",
  ...
  incompleteLinkBody:
    "Go back to the text message and tap the full https://effiroad.com/... link at the start of the message.",
...
export const linkIntakePageCopyEs: LinkIntakeCopy = {
  ...
  hvacSystemSectionTitle: "Sobre su equipo (opcional)",
  hvacSystemTypeLabel: "¿Qué dejó de funcionar?",
  hvacSystemTypePlaceholder: "ej. caldera, aire acondicionado, bomba de calor",
  hvacSystemTypeHint: "Solo la máquina que está rota o no funciona bien — omítalo si no está seguro.",
  hvacActiveIssueLabel: "Sin calor / sin frío ahora mismo",
