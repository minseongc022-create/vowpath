...
export const linkIntakePageCopy = {
  ...
  addressPlaceholder: "1234 Main St or your ZIP code",
  addressHintSearch:
    "Type your street or ZIP, then tap your home when it appears in the list.",
  addressHintManual:
    "Enter your full US service address so we can send the right tech.",
  addressLoading: "Turning on address search…",
  addressSearchReady: "Suggestions appear as you type — tap one to select it.",
  addressSearchError:
    "Address search is unavailable right now. You can type your address below or tap Try again.",
  addressSearchRetry: "Try address search again",
  ...
  addressPickRequired:
    "Pick your address from the list, or fill in street, city, state, and ZIP and tap Confirm address.",
  ...
  addressManualIncomplete: "Fill in street, city, state, and ZIP to continue.",
