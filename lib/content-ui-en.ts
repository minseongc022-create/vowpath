...
export const vowDashboardEn = {
  ...
  chase: {
    ...
    title: "Chase",
    subtitle:
      "Quotes you texted but haven't booked yet — we auto-nudge at 48 hours, 7 days, and 14 days (with SMS consent).",
    quotesLink: "Quotes",
    kpiActive: "In chase",
    kpiDue: "Due now",
    schedule: "Auto SMS: 48h · 7d · 14d after quote sent",
    loading: "Loading chase queue…",
    emptyTitle: "Nothing to chase",
    emptyBody: "When you text a quote, it lands here until the customer books or all follow-ups finish.",
    unnamed: "Customer",
    sent: "Quote sent",
