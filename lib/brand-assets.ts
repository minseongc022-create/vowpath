...
export const BRAND_ASSET_VERSION = "12";

export const BRAND_LOGO_HORIZONTAL_SRC = "/logo-horizontal-light.png?v=12";
export const BRAND_LOGO_ICON_SRC = "/logo-icon-light.png?v=12";
export const BRAND_LOGO_HORIZONTAL_SOLID_SRC = "/logo-horizontal.png?v=12";
export const BRAND_LOGO_HORIZONTAL_FOOTER_SRC = "/logo-horizontal-footer.png?v=12";
export const BRAND_LOGO_ICON_SOLID_SRC = "/logo-icon.png?v=12";
export const BRAND_LOGO_ICON_HEADER_SRC = "/logo-icon-header.png?v=12";
export const BRAND_LOGO_ICON_SITE_SRC = "/logo-icon-site.png?v=12";
export const BRAND_MARK_SRC = "/logo-mark.png?v=12";
