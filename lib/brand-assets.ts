...
export const BRAND_LOGO_HORIZONTAL_SRC = "/logo-horizontal-light.png";
export const BRAND_LOGO_ICON_SRC = "/logo-icon-light.png";
export const BRAND_LOGO_HORIZONTAL_SOLID_SRC = "/logo-horizontal.png";
export const BRAND_LOGO_HORIZONTAL_FOOTER_SRC = "/logo-horizontal-footer.png";
export const BRAND_LOGO_ICON_SOLID_SRC = "/logo-icon.png";
export const BRAND_LOGO_ICON_HEADER_SRC = "/logo-icon-header.png";
export const BRAND_LOGO_ICON_SITE_SRC = "/logo-icon-site.png";
