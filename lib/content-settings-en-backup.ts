...
export const SETTINGS_PAGE_EN = {
  ...
  forwardingSetupPrompt:
    "Not sure what to do? Answer 3 questions — we show the exact steps for YOUR phone (carrier, VoIP, or dedicated line).",
  ...
  forwardingQuiz: {
    ...
    q1UnsureHint: "Skip carrier codes — use your Effiroad number everywhere (Google, website, trucks).",
