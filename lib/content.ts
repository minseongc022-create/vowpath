...
const settingsPageKo = {
  ...
  forwardingQuiz: {
    badge: "1단계 · 경로 찾기",
    title: "고객 전화는 어디로 오나요?",
    subtitle: "질문 3개 — 검증된 가이드 하나만 보여 드립니다.",
    q1Label: "1. 고객이 거는 번호는?",
    q1ShopCell: "샵 휴대폰",
    q1BusinessVoip: "업무 전화 (Dialpad, Jobber, ServiceTitan, RingCentral…)",
    q1GoogleVoice: "Google Voice 번호",
    q1Unsure: "잘 모르겠음 — 가장 쉬운 방법",
    q2CarrierLabel: "2. 어떤 통신사?",
    q2Att: "AT&T / Cricket / Straight Talk",
    q2Tmobile: "T-Mobile / Metro / Mint",
    q2Verizon: "Verizon Wireless",
    q2Xfinity: "Xfinity Mobile",
    q2VoipLabel: "2. 어떤 전화 시스템?",
    ...
    q3OverflowHint: "내 폰이 먼저 울리고(~20초), 그다음 Effiroad.",
