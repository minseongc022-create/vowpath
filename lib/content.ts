...
const settingsPageKo = {
  ...
  goLiveWelcomeHint: "한 페이지씩 진행 — * 필수 항목을 채운 뒤 ‘저장하고 다음’을 누르세요. 마지막에 맨 아래에서 한 번에 저장하세요.",
  ...
  wizardPhoneRequired: "질문 3개를 끝내고, 우리 샵 전화 종류에 맞는 단계를 진행하세요.",
  ...
  forwardingSetupPrompt:
    "잘 모르겠다면 아래 질문 3개에 답하세요 — 우리 샵 전화(통신사·VoIP·전용번호)에 맞는 단계만 보여 드립니다.",
  ...
  forwardingQuiz: {
    ...
    q1Unsure: "잘 모르겠음 — 가장 쉬운 방법",
    q1UnsureHint: "착신 코드 없이 Effiroad 전용번호를 구글·웹·트럭에 올립니다.",
