...
export const onboardingPage = {
  ...
  steps: [
    {
      id: "schedule",
      title: "When should Vowpath answer?",
      description:
    ...
    },
    {
      ...
      description:
        "Add your Vowpath number in Dialpad or your phone system, follow the steps, and run a quick test.",
      action: "Continue",
      status: "ready" as const,
    },
    {
  ...
  liveBanner:
    "Once your hours and forwarding are set, Vowpath picks up calls and texts you summaries. Jobber is optional.",
...
const settingsPageKo = {
  ...
  allDone:
    "라이브 상태입니다. 설정한 시간에 Vowpath가 전화를 받고, 검토가 필요하면 문자로 알려드립니다.",
  tabOptional: "선택",
  tabSkipped: "건너뜀",
  statusDone: "연결됨",
  statusPending: "설정 필요",
  ...
  scheduleTitle: "응대 시간",
  scheduleDescription:
    "사무실이 비는 시간(퇴근 후, 주말, 점심 등)에 걸리는 전화를 Vowpath가 대신 받을 요일·시간을 정하세요. 예: 월–금 17:00~다음 날 08:00. 낮에도 항상 AI가 받게 하려면 「24시간 응대」를 켜세요.",
  scheduleAlwaysOn: "24시간 응대",
  scheduleAlwaysOnHint:
    "켜면 요일·시간과 관계없이 들어오는 전화를 모두 Vowpath가 받습니다. ③ 착신 전환도 24시간으로 맞추세요.",
  scheduleHourUnit: "시",
  ...
  forwardingNumberLabel: "Vowpath 번호",
  ...
  forwardingTestBody:
    "다른 휴대폰으로 샵 메인 번호에 전화해 보세요. 몇 번 울린 뒤(또는 영업시간 외 즉시) Vowpath가 받아야 합니다. 요약 문자가 오면 1=승인, 2=거절로 답하세요.",
  forwardingRecommended: "인기",
  forwardingRecommendedProvider: "권장",
  forwardingConfirmBlocked: "Vowpath 번호가 연결되어야 이 단계를 완료할 수 있습니다.",
  phoneGuide: "",
  phoneSupport: "",
  ...
  bookingPolicyTitle: "예약 · 일정 정책",
  bookingPolicyMode: "고객 시간 선택",
  bookingPolicyDescription:
    "고객이 통화 중 빈 시간대(최대 5개) 중 하나를 고릅니다. 모드에 따라 Jobber에 바로 반영되거나, 문자 1·2로 승인 후 반영됩니다.",
  ...
  slotOfferCountHint:
    "통화·문자 링크에서 고객이 고를 수 있는 빈 시간대 개수입니다. 예: 5개면 1~5번 중 하나를 선택합니다. 빠른 예약·하이브리드(일반 요청)에서 사용됩니다.",
  undoWindowLabel: "업주가 문자 9번으로 예약을 취소할 수 있는 시간 (분)",
  undoWindowHint:
    "고객이 시간을 고르고 예약이 자동 확정되면, 업주 휴대폰으로 알림 문자가 갑니다. 이 시간 안에 9번 답장하면 확정을 취소하고 다시 검토할 수 있습니다.",
  shadowModeLabel: "연습 모드 (테스트 통화 남은 횟수)",
  shadowModeIntro:
    "처음 연동하거나 예약 설정을 바꿀 때, Jobber·캘린더에 실제 기록 없이 통화 흐름만 점검하는 모드입니다.",
  shadowModeLive:
    "0 — 실전 운영: 고객이 시간을 고르면 캘린더·문자·Jobber에 그대로 반영됩니다.",
  shadowModePractice:
...
const vowDashboardKo = {
  ...
  calendar: {
    ...
    close: "닫기",
    vowpathBookings: "Vowpath 확정",
    jobberCalendar: "Jobber 일정",
    emptyNative: "아직 Vowpath에 확정된 방문이 없습니다.",
...
const dashboardPageKo = {
  ...
  setupComplete: "라이브 상태 — Vowpath가 설정한 시간에 전화를 받고 있습니다.",
  stats: {
    tonightCalls: "오늘 밤 콜",
    bookings: "서비스 요청",
