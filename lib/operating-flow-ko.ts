/** Marketing copy — Korean operating flow (legacy). */
...
export const OPERATING_FLOW_PHASES: OperatingFlowPhase[] = [

  {
    ...
    summary:
      ...
      "고객에게 보이는 번호는 지금 쓰는 업체 번호 그대로입니다. 못 받을 때·야간·주말에만 Effiroad로 착신전환합니다.",
    ...
    details: [
...

      {
        ...
        text: "안 받으면 / 통화중 / 몇 초 후 → Effiroad 번호로 넘깁니다.",
...

  {
    ...
    summary:
      ...
      "Effiroad로 넘어온 전화에서 AI가 전화 접수와 링크 접수 중 선택을 안내합니다. 연락처·주소·증상을 받아 요약합니다.",
...
export const HERO_FLOW_LOOP_SUMMARY =
  ...
  "고객이 전화·링크로 접수하면 Effiroad가 업체에 승인 요청 문자를 보냅니다. 업체가 1(승인) 또는 2(거절)로 답하면 고객에게 결과 문자가 자동으로 갑니다.";
...
export const OPERATING_FLOW_NODES = [
  ...
  { id: "effiroad", title: "Effiroad AI", caption: "요약 · 승인 요청 생성" },
