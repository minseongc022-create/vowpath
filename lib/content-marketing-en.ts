...
export const pricingEn = {
  ...
  compare: [
    ...
    { label: "AI quality", amount: "Economy → Premium by plan" },
  ],
  plans: [
    {
      id: "lite" as const,
      name: "Lite",
      badge: "Quiet months",
      description: "Lowest base. Economy AI. Pay only when you approve a real dispatch — estimates stay free.",
    ...
    },
    {
      ...
      name: "Pro",
      badge: "Growing shops",
      description: "Flat rate + Premium AI. Estimates free. Dispatches counted toward your monthly cap.",
      price: SITE.proPrice,
      period: "/mo",
