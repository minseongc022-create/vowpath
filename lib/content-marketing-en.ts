...
export const pricingEn = {
  ...
  compare: [
    ...
    { label: "AI quality", amount: "Premium AI on every plan" },
  ],
  plans: [
    {
      id: "lite" as const,
      name: "Lite",
      badge: "Quiet months",
      description: "Lowest base. Premium AI. Pay only when you approve a real dispatch — estimates stay free.",
      ...
      features: [
        ...
        "Premium AI emergency intake",
        `+ ${SITE.litePerBooking} only when you approve a dispatch`,
        "Crew SMS with 1/2 owner hold · CRM optional",
      ],
      recommended: false,
    ...
    },
    {
      ...
      name: "Flex",
      badge: "Most popular",
      description: "Best $/dispatch for independents. Estimates free; you pay when a job is approved.",
      ...
      features: [
        "Free estimate calls included ($0)",
        "Premium AI intake + dispatch notes",
        `Lower per-dispatch (${SITE.flexPerBooking}) than Lite`,
        "Tech-lane routing + booking windows · CRM optional",
      ],
      recommended: true,
    ...
    },
    {
      ...
      name: "Pro",
      badge: "Growing shops",
      description: "Flat rate + included dispatches. Premium AI. Estimates free. Dispatches counted toward your monthly cap.",
      price: SITE.proPrice,
      period: "/mo",
      ...
      features: [
        ...
        "Predictable overage — alerts first · CRM optional",
      ],
      recommended: false,
    ...
    },
    {
      ...
      name: "Scale",
      badge: "Storm season",
      description: "Premium AI at high volume. Estimates free. Lowest overage on busy nights.",
