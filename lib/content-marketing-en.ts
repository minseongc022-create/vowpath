...
export const pricingEn = {
  ...
  subtitle:
    "Economy AI on Lite & Flex keeps nights affordable. Premium AI on Pro & Scale when volume (and stakes) go up — pick by dispatch count, not guesswork.",
  compare: [
    { label: "AI phone + link intake", amount: "Included" },
    { label: "Crew SMS dispatch + owner 1/2 hold", amount: "Included" },
    { label: "AI quality", amount: "Economy → Premium by plan", highlight: true },
    { label: "CRM / Jobber sync", amount: "Optional" },
  ],
  plans: [
    {
      id: "lite" as const,
    ...
    },
    {
      ...
      name: "Flex",
      badge: "Most popular",
      description: "Best $/dispatch for typical independents. Same Economy AI stack as Lite.",
      price: SITE.flexBasePrice,
      period: "/mo",
      usageLine: `+ ${SITE.flexPerBooking} per approved dispatch`,
      volumeGuide: planVolumeGuideEn("flex"),
      features: [
        "Economy AI intake + dispatch notes",
        "Lower per-dispatch than Lite",
        "Tech-lane routing + booking windows",
        "CRM optional",
      ],
      recommended: true,
