...
export const RESTORATION_PHONE_TIMELINE: PhoneDemoPhase[] = [
  ...
  { kind: "system", text: "Sending secure link by text…", delayMs: 1200 },
  {
    kind: "sms",
  ...
  { kind: "customer-text", text: "4821 Oak Drive, Austin TX", delayMs: 800 },
  { kind: "customer-text", text: "Today 8:00–10:00 AM", delayMs: 900 },
  { kind: "system", text: "Visit scheduled · Owner approval needed", delayMs: 1000 },
  {
    kind: "sms",
...
export const HVAC_PHONE_TIMELINE: PhoneDemoPhase[] = [
  ...
  { kind: "customer-text", text: "910 Cedar Lane, Round Rock TX", delayMs: 800 },
  { kind: "customer-text", text: "Today 9:00–11:00 AM", delayMs: 900 },
  { kind: "system", text: "Visit scheduled · Auto-dispatching crew", delayMs: 1000 },
  {
    kind: "sms",
