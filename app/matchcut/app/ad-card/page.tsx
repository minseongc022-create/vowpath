...
import { MatchCutAdCardStudio } from "@/components/matchcut/MatchCutAdCardStudio";
...
export default async function MatchCutAdCardPage() {
  ...
  return (
    <MatchCutAppShell displayName={session.displayName} credits={credits.total}>
      <MatchCutAdCardStudio initialCredits={credits.total} />
    </MatchCutAppShell>
  );
}
