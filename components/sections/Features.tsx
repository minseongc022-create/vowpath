...
const icons = [
  ...
  <svg key="2" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M4.5 9.75h15M4.5 19.5h15a1.5 1.5 0 001.5-1.5V9.75L4.5 9.75v8.25a1.5 1.5 0 001.5 1.5z" />
  </svg>,
