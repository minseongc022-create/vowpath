...
export function IconQuotes({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} width={16} height={16} viewBox="0 0 20 20" fill="currentColor" aria-hidden>
      <path
        fillRule="evenodd"
...
export function IconChase({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} width={16} height={16} viewBox="0 0 20 20" fill="none" stroke="currentColor" aria-hidden>
      <circle cx="10" cy="10" r="7" strokeWidth="1.5" />
      <path d="M10 6v4l2.5 2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

export function IconAgreements({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} width={16} height={16} viewBox="0 0 20 20" fill="currentColor" aria-hidden>
      <path
        fillRule="evenodd"
