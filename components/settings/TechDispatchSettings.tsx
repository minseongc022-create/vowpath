...
function copy(isEnglish: boolean) {
  return isEnglish
    ? {
        ...
        body: "On calendar confirm, Vowpath offers the job to one tech at a time (round-robin). They reply 1=accept or 2=pass. After accept, they text OTW30 when heading out — customer gets an ETA SMS.",
        enable: "Enable crew text assignment",
        p1Senior: "Emergencies (P1) — senior techs only",
        techsLabel: "Your techs",
        techsHint:
          "US mobile or KR 010 for testing. Solo test? Use YOUR phone — then reply 1 / OTW30 from the same device.",
        namePh: "Name",
    ...
    : {
        ...
        body: "캘린더에 확정되면 기사에게 문자로 한 명씩 순차 제안합니다. 1=수락, 2=패스. 수락 후 출발할 때 OTW30 문자 → 고객에게 ETA SMS.",
        enable: "기사 문자 배치 사용",
        p1Senior: "긴급(P1) — 시니어 기사만",
        techsLabel: "기사 목록",
        techsHint:
          "미국 번호 또는 테스트용 010. 혼자 테스트? 본인 번호 넣고 같은 폰에서 1 / OTW30 회신.",
        namePh: "이름",
        phonePh: "(512) 555-0100",
        senior: "시니어",
        remove: "삭제",
