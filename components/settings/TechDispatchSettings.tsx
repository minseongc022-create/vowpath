...
function copy(isEnglish: boolean) {
  return isEnglish
    ? {
        ...
        body: "On calendar confirm, Vowpath offers the job to one tech at a time (round-robin). They reply 1=accept or 2=pass. When heading out, they reply 5, 10, 15, 30, 45, or 60 — customer gets an ETA SMS.",
    ...
    : {
        ...
        body: "캘린더에 확정되면 기사에게 문자로 한 명씩 순차 제안합니다. 1=수락, 2=패스. 출발할 때 5·10·15·30·45·60 중 숫자만 회신 → 고객에게 ETA SMS.",
        enable: "기사 문자 배치 사용",
