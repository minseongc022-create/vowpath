...
const COPY = {
  ...
  body: "When a job confirms, we text your crew one at a time. They reply 1 = yes, 2 = pass. You never text the customer from a personal phone — Effiroad handles that.",
  enable: "Text my crew when a job confirms",
  ...
  responseTimeoutHint: "No reply? The text goes to the next person on the list.",
  assignOnApproveHint: "Off = crew gets text as soon as the job confirms.",
