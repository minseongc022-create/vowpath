  ...
  theme: {
    extend: {
      colors: {
        ...
        // 채비 — 깊은 자주 하나를 축으로 하는 단색 체계.
        // 실제 값은 chaebi/styles/chaebi.css의 CSS 변수가 원본이고,
        // 여기 있는 건 Tailwind 유틸리티에서 같은 색을 부르기 위한 별칭이다.
        cb: {
          bg: "var(--cb-bg)",
          surface: "var(--cb-surface)",
          "surface-alt": "var(--cb-surface-alt)",
          "surface-sunken": "var(--cb-surface-sunken)",
          ink: "var(--cb-ink)",
          "ink-soft": "var(--cb-ink-soft)",
          muted: "var(--cb-muted)",
          subtle: "var(--cb-subtle)",
          border: "var(--cb-border)",
          "border-strong": "var(--cb-border-strong)",
          primary: "var(--cb-primary)",
          "primary-hover": "var(--cb-primary-hover)",
          "primary-soft": "var(--cb-primary-soft)",
          "primary-line": "var(--cb-primary-line)",
          good: "var(--cb-good)",
          "good-soft": "var(--cb-good-soft)",
          warn: "var(--cb-warn)",
          "warn-soft": "var(--cb-warn-soft)",
          danger: "var(--cb-danger)",
          "danger-soft": "var(--cb-danger-soft)",
        },
        ts: {
          bg: "#f4f5f7",
          surface: "#ffffff",
