...
test("Retell STT settings favor accurate listening", async () => {
  ...
  assert.equal(patch.denoising_mode, "noise-and-background-speech-cancellation");
  ...
  assert.match(RETELL_PROMPT_VERSION, /fast-listen-friendly-sms-v40|phone-clarity-v39|human-natural-voice-v38|clear-fast-voice-v37/);
});
