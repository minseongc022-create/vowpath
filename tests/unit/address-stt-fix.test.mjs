...
test("Retell STT settings favor accurate listening", async () => {
  ...
  assert.match(RETELL_PROMPT_VERSION, /human-natural-voice-v38|clear-fast-voice-v37|clear-fast-voice-v36|clear-fast-voice-v35|clear-fast-voice-v34|quote-chase-clear-voice-v32|channel-menu-clear-voice|hybrid-address|accurate-stt/);
});
