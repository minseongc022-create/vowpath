...
test("Retell STT settings favor accurate listening", async () => {
  ...
  assert.match(RETELL_PROMPT_VERSION, /clear-fast-voice-v34|clear-fast-voice-v33|quote-chase-clear-voice-v32|channel-menu-clear-voice|hybrid-address|accurate-stt/);
});
